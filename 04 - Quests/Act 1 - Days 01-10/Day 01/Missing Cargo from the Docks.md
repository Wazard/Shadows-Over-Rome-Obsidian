...
NPCs:
  ...
  - "[[Naso Rotto]]"
source:
  - Wazard/Shadows-over-Rome/phase 1/quests/Day1/Day1_Missing_Cargo.docx
---
...
Rischio: tensione con lavoratori, possibile breve scontro.
...
- [[Harbor District]]
- area intorno a [[Il Veliero]]
- molo commerciale
- zona di scarico laterale
- magazzini di conteggio
- la nave mercantile *Chimera di Giada*
...
- "Noi scarichiamo. Roma conta. Roma perde. Poi Roma ci guarda come ladri."
- "Se cercate il capitano, chiedete bene. Se cercate colpe, cercatele a terra."
- "Il carico e uscito dalle nostre mani intero."

### [[Captain Linh Sura]]

Interviene solo se i PG sono rispettosi o hanno prove. E asciutta, precisa e poco paziente.
...
## Fase 1 - Capire Chi Aveva il Carico

I PG devono ricostruire il passaggio:

`stiva -> molo -> conteggio nave -> conteggio romano -> zona laterale -> magazzino assegnato`

La frattura avviene tra conteggio romano e magazzino assegnato.
...
| Stoffa nera strappata | Percezione CD 13; Conoscenze locali CD 17 | Ricco, ufficiale o falso indizio | Traccia di intermediario incappucciato |
| Schegge di cassa | Percezione CD 10 | Furto ordinario | Misdirection efficace |

## Fase 3 - Testimoni sotto Pressione

Se i PG fanno domande rumorose, tre magazzinieri ubriachi li affrontano. Non sono capi. Sono persone che difendono il proprio spazio e temono di perdere paga.

Frasi:

- "Avete finito di ficcare il naso?"
- "Questo e lavoro di porto. Voi siete appena arrivati."
- "Se manca una cassa, manca una cassa. Non siete i primi a scoprirlo."

Risoluzioni:

| Approccio | Esito |
| --- | --- |
| Calma e monete | Uno ricorda uomini con mani troppo pulite |
| Intimidazione | Uno ammette che qualcuno ha detto loro di guardare altrove |
| Accusa pubblica | Rissa breve |
| Mostrare rispetto per il lavoro | Ottengono una descrizione della zona laterale |

## [[Naso Rotto]]

Dopo due round di rissa, o se i PG mettono troppa pressione sui testimoni, arriva [[Naso Rotto]]. Non entra urlando. Si limita a occupare spazio.
...
I PG confermano la perdita ma non capiscono la deviazione. Ricevono pagamento, ma il porto li considera solo altri ficcanaso.

### Fallimento con Conseguenze

Se fanno rissa pubblica o accusano la nave senza prove, la *Chimera di Giada* diventa diffidente e i magazzinieri rifiutano di parlare nei giorni successivi.

## Ricompense

- Pagamento basso-buono.
- Possibile rapporto positivo con [[Sajan Qadir]].
- Indizi su deviazioni di carico.
- Primo contatto indiretto con uomini legati ad Aulus.
