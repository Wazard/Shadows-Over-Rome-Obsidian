...
tags:
  ...
  - faction/other
Faction: "Governo cittadino"
race: "Elfo - apparenza umana"
role: "Governatore eletto della città"
...
Pragmatico, sotto pressione, più debole politicamente di quanto vorrebbe ammettere.

Al tavolo, interpreta Remus Aurelianus con un obiettivo semplice e immediato. Vuole conservare qualcosa: reputazione, sicurezza, profitto, fede, lavoro, segreti o dignita. Se i PG danno a questa persona modo di ottenere quel bisogno senza umiliarlo, diventa piu utile. Se lo mettono all'angolo, reagisce in modo pratico prima che drammatico: mente, prende tempo, chiama qualcuno, chiude una porta o cambia versione.

## Uso in Campagna

Rappresenta l’inerzia e la fragilità del governo; può essere ostacolato da Varro e dai funzionari corrotti.

Funzione consigliata: dare volto alla burocrazia, alle ronde e alla tensione tra legge e convenienza. Gioca il peso dell'uniforme prima della violenza.

Remus Aurelianus non deve spiegare la trama al posto dei PG. Deve dare attrito, colore e conseguenze. Quando serve un indizio, fallo arrivare attraverso qualcosa che ha visto, comprato, registrato, sentito o temuto, non attraverso una confessione completa.

## Impressione per i Giocatori

Sembra il classico governatore oberato, forse incompetente, forse solo circondato male.
...
- Usa Remus Aurelianus come volto riconoscibile della vita quotidiana romana, utile per rendere una strada o una quest meno anonima.
- Se i PG trattano Remus Aurelianus con rispetto, puo offrire una voce, una scorciatoia sociale o un dettaglio osservato per caso.
- Se i PG fanno pressione nel modo sbagliato, Remus Aurelianus si chiude, chiede protezione a qualcuno o trasforma una scena semplice in reputazione negativa.

## Segreti, Pressione e Reazioni

- **Se aiutato:** Remus Aurelianus ricorda il favore e puo restituirlo con informazioni minori, accesso sociale, una voce o un avvertimento.
