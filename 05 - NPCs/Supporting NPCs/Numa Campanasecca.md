...
race: "Umano"
role: "Ex accolito / trama secondaria del tempio"
...
| Stirpe | Umano |
| Ruolo | Ex accolito / trama secondaria del tempio |

## Descrizione Estesa

Numa Campanasecca e una presenza urbana di supporto legata a **Alternative_NPC**. Il tratto di partenza piu evidente e questo: Uomo magro con mani rovinate dal bronzo e dall’incenso, veste povera, collo sempre piegato come se ascoltasse campane lontane.
...
Colpevole, nervoso, superstizioso. Sa che alcune campane del tempio non sono state semplicemente vendute.
...
Trama secondaria: furto di bronzo sacro, campane scomparse, collegabile a contrabbando o rituali minori.
...
Numa Campanasecca non deve spiegare la trama al posto dei PG. Deve dare attrito, colore e conseguenze. Quando serve un indizio, fallo arrivare attraverso qualcosa che ha visto, comprato, registrato, sentito o temuto, non attraverso una confessione completa.

## Impressione per i Giocatori

Sembra un ex religioso fallito che beve troppo e parla per enigmi.
...
- Usa Numa Campanasecca come volto riconoscibile della vita quotidiana romana, utile per rendere una strada o una quest meno anonima.
- Se i PG trattano Numa Campanasecca con rispetto, puo offrire una voce, una scorciatoia sociale o un dettaglio osservato per caso.
- Se i PG fanno pressione nel modo sbagliato, Numa Campanasecca si chiude, chiede protezione a qualcuno o trasforma una scena semplice in reputazione negativa.

## Segreti, Pressione e Reazioni

- **Se aiutato:** Numa Campanasecca ricorda il favore e puo restituirlo con informazioni minori, accesso sociale, una voce o un avvertimento.
