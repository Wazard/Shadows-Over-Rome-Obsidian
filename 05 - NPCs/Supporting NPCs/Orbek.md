...
Faction: "Bassifondi"
race: "Mezzorco"
role: "Ex guardia, ora buttafuori"
...
| Fazione | Bassifondi |
| Stirpe | Mezzorco |
| Ruolo | Ex guardia, ora buttafuori |

## Descrizione Estesa

Orbek e una figura dell'ordine cittadino legata a **Bassifondi**. Il tratto di partenza piu evidente e questo: Mezzorco con vecchia corazza senza insegne, naso rotto e mani da combattente.
...
Orbek non deve spiegare la trama al posto dei PG. Deve dare attrito, colore e conseguenze. Quando serve un indizio, fallo arrivare attraverso qualcosa che ha visto, comprato, registrato, sentito o temuto, non attraverso una confessione completa.

## Impressione per i Giocatori

Sembra un buttafuori pericoloso ma non stupido.
...
- Usa Orbek per controlli, pedinamenti, accessi negati o una presenza armata che costringe i PG a scegliere il tono della scena.
- Se i PG trattano Orbek con rispetto, puo offrire una voce, una scorciatoia sociale o un dettaglio osservato per caso.
- Se i PG fanno pressione nel modo sbagliato, Orbek si chiude, chiede protezione a qualcuno o trasforma una scena semplice in reputazione negativa.

## Segreti, Pressione e Reazioni

- **Se aiutato:** Orbek ricorda il favore e puo restituirlo con informazioni minori, accesso sociale, una voce o un avvertimento.
